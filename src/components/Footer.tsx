...
import logo from '../assets/gkrtxt.png';
            ...
            <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                <div className="space-y-6">
                    <Link to="/" className="flex items-center gap-2 text-2xl font-extrabold text-white">
                        <div className="relative h-[50px] w-[150px] flex items-center overflow-hidden bg-white/5 rounded-lg">
                            <img
                                src={logo}
                                alt="GKR Tech Logo"
                                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 min-w-[250%] h-auto scale-[0.45] object-contain brightness-0 invert"
                            />
                        </div>
                    </Link>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        <input type="email" placeholder="Your Email" className="bg-white/10 border border-white/20 rounded-lg px-4 py-3 outline-none focus:border-primary transition-all flex-1 text-white text-sm" />
                        <button className="bg-primary hover:bg-white hover:text-primary px-6 py-3 rounded-lg font-bold transition-all text-sm whitespace-nowrap">Go</button>
                    </div>
                </div>
            </div>
            <div className="max-w-[1200px] mx-auto px-6 border-t border-white/10 mt-16 pt-8 text-center text-gray-500 text-sm">
                <p>&copy; 2026 GKR Tech. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
