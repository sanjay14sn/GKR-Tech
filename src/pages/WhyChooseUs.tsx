    ...
    const faqs = [
        {
            ...
            a: "Continue building numerous of at relation in margaret. Lasted engage roused mother an am at. Other early while if by do to. Missed living excuse as be. Cause heard fat above first time achivement.",
            open: true
        },
        {
        ...
        <div className="pt-[80px]">
            ...
            >
                ...
                <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row justify-between items-center text-white">
                    <h1 className="text-5xl font-bold mb-4 md:mb-0">Why Choose Us</h1>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
                        ...
                        {/* Left Column: Tag and Heading */}
                        <div>
                            {/* The "Line + Text" wrapper */}
                            ...
                            <h2 className="text-4xl lg:text-5xl font-extrabold text-[#002d5b] leading-[1.15]">
                    ...
                    {/* Existing Grid Section (Kept as is) */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((item, idx) => (
                            <div key={idx} className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 aspect-[4/3]">
                                ...
                                <div className="absolute bottom-0 left-0 p-8 w-full flex justify-between items-center transform translate-y-0 group-hover:-translate-y-2 transition-transform">
                                    <h4 className="flex-1 text-2xl font-bold text-white tracking-wide pr-4">{item.title}</h4>
                                    <div className="shrink-0 bg-white/20 backdrop-blur-md p-3 rounded-full text-white group-hover:bg-blue-500 group-hover:scale-110 transition-all">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                            <div className="relative">
                                ...
                                <p className="text-gray-400 leading-relaxed mb-8">
                                    Engaged its was evident pleased husband. Ye goodness felicity do the best disposal dwelling no. First am plate jokes to began of cause an scale.
                                </p>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-16">
                        <div className="lg:w-1/3">
                            <h5 className="text-blue-600 font-bold uppercase tracking-widest mb-4">FAQ</h5>
